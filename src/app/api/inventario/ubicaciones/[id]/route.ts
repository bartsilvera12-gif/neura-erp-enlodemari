...
export async function PATCH(
  ...
  try {
    ...
    if (body.codigo !== undefined) patch.codigo = body.codigo == null ? null : String(body.codigo);
    ...
    if (body.descripcion !== undefined) patch.descripcion = body.descripcion == null ? null : String(body.descripcion);
