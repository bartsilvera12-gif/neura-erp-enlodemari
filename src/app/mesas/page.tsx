...
interface MesaStyle {
  card: string;   // fondo + borde + hover de la tarjeta
  tile: string;   // "tile" del número
  pill: string;   // pastilla de estado
  dot: string;    // punto del estado (leyenda + pastilla)
  label: string;
}
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6">
          {mesas.map((m) => {
            ...
            return (
              ...
              >
                {/* Número en tile tintado por estado */}
