...
function rowToProducto(row: ProductoRow): Producto {
  return {
    ...
    sector_produccion: (row.sector_produccion as Producto["sector_produccion"]) ?? "ninguno",
  };
}
...
export async function saveProducto(
  ...
  const body = {
    ...
    sector_produccion: datos.sector_produccion ?? "ninguno",
  };
...
export async function updateProducto(
  ...
  if (datos.sector_produccion !== undefined) body.sector_produccion = datos.sector_produccion;
